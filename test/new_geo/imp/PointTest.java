...
public class PointTest {
    ...
    private final basic.IPoint p = INJECTOR.getInstance(basic.IPoint.class);
    private final basic.IPoint q = INJECTOR.getInstance(IPoint.class);
