...
public final class Collision {
     ...
     * 
     * 
     * // Kollision der Bounding-Boxen prüfen
     * if(!l.getBoundingBox().collide(c.getBoundingBox())) { return false; }
     */

    /*
     * / Prüfen, ob Anfangspunkt der Linie im Kreis liegt
     * if(l.getPoint(0).getDistanceToPointSq(c.getMid()) <= c.getRadiusSq()) {
     * return true; }
     */
    /*
     * / Prüfen, ob Endpunkt der Linie im Kreis liegt
     ...
     * Punkt liegt außerhalb if(t < 0 || t > 1) { return false; // Punkt liegt
